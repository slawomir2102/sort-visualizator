...
export const QuickSortVisualizer = () => {
    ...
    useEffect(() => {
        ...
        const currentOperation: QuickSortStep = simulator.operations[currentStep];
        ...
        if (newSwapFirstIndex !== swapFirstIndex) setSwapFirstIndex(newSwapFirstIndex);
        if (newSwapSecondIndex !== swapSecondIndex) setSwapSecondIndex(newSwapSecondIndex);
        if (newPartitionStart !== partitionStart) setPartitionStart(newPartitionStart);
        ...
        if (steppingDirection === "forward") {
            ...
            if (currentOperation.sortedElements && currentOperation.sortedElements.indexes) {
